...
\newlength\mywidth
\newlength\myheight
\begin{document}\pagecolor{Linen!30!white}%
\settowidth\mywidth{\reflectbox{\turm{dark}} \turm{light}}%
\settoheight\myheight{\reflectbox{\turm{dark}} \turm{light}}%
\fbox{\raisebox{-0.5\height}[0.5\mywidth][0.5\mywidth]{\reflectbox{\turm{dark}} \turm{light}}}
\end{document}
